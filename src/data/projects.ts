// All projects shown on projects.adityajain.me, in display order.
//
// - `href`  : primary link (repo / gist / Docker Hub) — the card's stretched link.
// - `image` : optional thumbnail. Local files live in /public/img; a few point at
//             remote screenshots hosted in the source repos (kept as-is from the
//             legacy site so we don't duplicate large assets).
// - `demo`  : optional live demo / interactive link.
// - `blog`  : optional companion blog post on the main portfolio.
